...
% -------- Revision markup for reviewer traceability --------
% Uses coloured text (goldenrod, a yellow-tinted colour) rather than \hl{}
% background highlighting because soul's \hl{} is unreliable with inline
% math ($...$) and \cite{} inside its argument. Colour-based markup is
% robust against math, citations, and \ref{}, and remains visually
% distinct from body text for reviewer tracking.
\definecolor{revhi}{HTML}{B8860B}       % dark goldenrod, prints legibly on white
\newcommand{\yh}[1]{{\color{revhi}#1}}  % wrap all revision-added text for review
\linenumbers
